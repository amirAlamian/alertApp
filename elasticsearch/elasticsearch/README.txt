...
1. This README file
2. http-docker-cluster.csr
3. http-docker-cluster.key
4. sample-elasticsearch.yml

## http-docker-cluster.csr

The "http-docker-cluster.csr" file is a Certificate Signing Request.
...
In either case, you need to provide the http-docker-cluster.csr file to the certificate authority, and they will provide you with your signed certificate.
For the purposes of this document, we assume that when they send you your certificate, you will save it as a file named "http-docker-cluster.crt".
...
## http-docker-cluster.key

The "http-docker-cluster.key" file is your private key.
...
certificate. When you have a copy of the certificate you should copy it and the private key ("http-docker-cluster.key") to the config directory.
The sample config assumes that the certificate is named "http-docker-cluster.crt".
